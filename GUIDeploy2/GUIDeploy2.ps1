...
Xavier AVRILLIER
EMail    : Xavier.avrillier@ext.consilium.europa.eu
Description : GUI to simplify and automate the deployment of virtual machines.

17/10/2019 - Versions Pre-Requisites
---------------
Added checks for minimum version of PowerShell and PowerCLI.

17/09/2019 - Bug fix and minor changes.
---------------
Fixed bug with credentials triggered by error handling.
Unlock form after error happened.
Refresh datastore storage info after deployment.

13/09/2019 - Visual changes, error handling and cleanup
---------------
Code cleanup (PSScriptAnalyzer).
Added error handling (try catch) in deployment function.
Added a progress bar to track the deployment.
Added check for multiple folders with same name (see known issues).

11/09/2019 - Minor changes
---------------
Set custom spec to workgroup if Windows and No-Domain selected.
Display attributes form only if they exist.

06/09/2019 - Minor changes
---------------
Removed credentials check with Linux custom spec.
Made "No-Domain" prohibited with Linux custom spec.
Disable Credentials button when Linux custom spec selected.
Extended range of memory values.

29/08/2019 - Minor changes
---------------
Added memory in calculation of datastore space.
Added datastore selection through "Details" view.
Press Enter to connect vCenter instead of having to click on it.

28/08/2019 - V1
---------------
Supports Windows and Linux.
Supports custom attributes.
Based on an existing custom specifications file.
Checks include datastore space and provisioning, VM name, memory usage, current CPU usage.


**************************
Known issues to fix maybe
**************************
- Problem if multiple VM folders with the same name (see 13/09/2019 change). A fix could be open the full path in OGV at folder selection, validation, new button (not preferred).
